    ...
    <div className={rootClass}>
      ...
      {isEmpty ? (
        <div className="flex-1 px-4 flex flex-col justify-center items-center">
          ...
          <p className="text-accents3 px-10 text-center pt-2">
        ...
        <>
          <div className="px-4 sm:px-6 flex-1">
            ...
            <ul className="py-6 space-y-6 sm:py-0 sm:space-y-0 sm:divide-y sm:divide-accents3 border-t border-accents3">
              Cart Items Here!
            </ul>
          </div>
          <div className="flex-shrink-0 px-4  py-5 sm:px-6">
            <div className="border-t border-accents3">
              <ul className="py-3">
              ...
              <div className="flex justify-between border-t border-accents3 py-3 font-bold mb-10">
                <span>Total</span>
                <span>120$</span>
              </div>
            </div>
